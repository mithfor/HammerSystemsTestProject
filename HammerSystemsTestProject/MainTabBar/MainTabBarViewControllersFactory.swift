...
class MainTabBarViewControllersFactory {
    static func makeMenuViewController() -> UIViewController {
        ...
        vc.tabBarItem.image = UIImage(named: Constants.Strings.IconFill.menu) ?? UIImage()
        return vc
    }
    ...
    static func makeContactsViewController() -> UIViewController {
        ...
        vc.tabBarItem.image = UIImage(named: Constants.Strings.IconFill.contacts) ?? UIImage()
        return vc
    }
    ...
    static func makeProfileViewController() -> UIViewController {
        ...
        vc.tabBarItem.image = UIImage(named: Constants.Strings.IconFill.profile) ?? UIImage()
        return vc
    }
    ...
    static func makeCartViewController() -> UIViewController {
        ...
        vc.tabBarItem.image = UIImage(named: Constants.Strings.IconFill.cart) ?? UIImage()
        return vc
    }
}
